...
def emit_client_init(sync: bool) -> list[str]:
    ...
    return [
        ...
        "            return str(body).encode('utf-8'), content_type",
        "        if content_type and (content_type.startswith('application/xml') or content_type.startswith('text/xml') or content_type.endswith('+xml')):",
        "            return str(body).encode('utf-8'), content_type",
        "        if content_type and (content_type.startswith('application/yaml') or content_type.startswith('application/x-yaml') or content_type.startswith('text/yaml')):",
        "            return json.dumps(body).encode('utf-8'), content_type",
        "        return json.dumps(body).encode('utf-8'), content_type",
        "",
        ...
        "            return data.decode('utf-8')",
        "        if content_type.startswith('application/xml') or content_type.startswith('text/xml') or content_type.endswith('+xml'):",
        "            return data.decode('utf-8')",
        "        if content_type.startswith('application/yaml') or content_type.startswith('application/x-yaml') or content_type.startswith('text/yaml'):",
        "            try:",
        "                return json.loads(data)",
